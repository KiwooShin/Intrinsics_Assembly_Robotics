...
cleanup_sim() {
  ...
  pids=$(ps aux | grep -E "gz sim|aic_model|aic_engine|aic_adapter|static_transform_publisher|component_container|rmw_zenohd|robot_state_publisher|topic_tools/relay|ros_gz_bridge|parameter_bridge" \
